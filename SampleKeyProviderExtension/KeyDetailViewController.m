...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    NSString *detail = nil;
    detail = [keyChain getAttrValueAtSection:_itemIndex attrIndex:indexPath.row];

    CGSize detailSize = [detail sizeWithFont:[UIFont systemFontOfSize:FONT_SIZE] constrainedToSize:constraint lineBreakMode:NSLineBreakByWordWrapping];
...
{
    [_dpvc dismissAndUnselect];
    [_dpvc dismissViewControllerAnimated:NO completion:nil];
}
@end
