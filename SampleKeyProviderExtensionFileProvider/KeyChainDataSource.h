...
/**
 The KeyStore class is intended to function as a data source for table views displaying
...
@property (nonatomic, retain) NSArray* utis;
...
- (id) initWithMode:(enum KeyChainDataSourceMode)mode password:(NSString*)s;
- (void) ClearContents;
